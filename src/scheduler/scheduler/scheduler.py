...
class Scheduler(Node):
    def __init__(self):
        ...
        self.new_job_log_path = "./src/scheduler/scheduler/newJobLog.csv"  # Relative so that it works on any machine
    ...
    def remove_job_from_log(self, msg):
        ...
        with open(self.job_log_path, 'r') as f:                 # open csv file to read
            with open(self.new_job_log_path, 'w') as ff:        # open csv file to write
